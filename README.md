...
Inputs:
    ...
    --deseq: CSV file result from DESeq2. Must contain columns "log2FoldChange" and "pvalue"
...
Outputs:
    ...
    hitchhiker_report.txt: Reports noncoding genes with a coding one in proximity at several distance thresholds
